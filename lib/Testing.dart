...
//               // ),
//               ///
//               ///Widget of Dragable Bottom Sheet
...
//               //                           )
//               //                               : Text(
//               //                             " ${mySelectedEvents[DateFormat('yyyy-MM-dd').format(_selectedDate!)]!.length} Events", style: TextStyle(color: Colors.white),),
//               //                         ),
//               //                       ],
//               //                     ),
//               //                   ),
...
//               //                                               TextButton(
//               //                                                   onPressed: () {
//               //                                                     var newList = mySelectedEvents[DateFormat(
//               //                                                         'yyyy-MM-dd')
//               //                                                         .format(
//               //                                                         _selectedDate!)]!;
//               //
...
//               //                                                       DateFormat('yyyy-MM-dd').format(_selectedDate!)]
//               //                                                           ?.clear();
//               //                                                       // _listOfDayEvents(_selectedDate!).remove(titleController);
//               //                                                       // mySelectedEvents.removeWhere((key, value) => false);
//               //                                                     });
//               //                                                     Navigator.pop(
//               //                                                         context);
//               //                                                   },
...
// Widget _TCalendarP (BuildContext context, tController, _focusedDay, _calendarFormat, _selectedDate, _listOfDayEvents) {
//   return Padding(
//     padding: const EdgeInsets.all(8.0),
//     child: Container(
//       decoration: BoxDecoration(
...
// Widget _TCalendarL (BuildContext context, tController, _focusedDay, _calendarFormat, _selectedDate, _listOfDayEvents) {
//   return Padding(
//     padding: const EdgeInsets.all(8.0),
//     child: Container(
//       decoration: BoxDecoration(
